package walker.iterative.deepening.search;
...
public class IterativeDeepening 
{
	...
	public void interativeDeepening(int adjacencyMatrix[][], int destination)
	{
	...
	public static void main(String[] args) {
		...
		try
		{
			...
			iterativeDeepening.interativeDeepening(adjacency_matrix, destination);
